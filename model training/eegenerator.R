...
library(stringi)
z<-readLines('ee2.txt',encoding="UTF-8",skipNul=TRUE)
...
for(iteration in 1:20){
  ...
  for(diversity in c(.05,.1,0.2, 0.5, 1, 1.2)){
...
save_model_hdf5(model,'EE256-64.hd5') 
saveRDS(text,'EE256-64text.RDS')
saveRDS(chars,'EE256-64chars.RDS')
