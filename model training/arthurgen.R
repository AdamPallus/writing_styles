...
library(stringi)
z<-readLines('arthur2.txt',encoding="UTF-8",skipNul=TRUE)
...

{
  ...
  for(diversity in c(0.005,0.05,0.1,0.2,.4,.6,.8,1)){
    for (repeats in 1:3){
...
save_model_hdf5(model,'ArthurModel1b.hd5') 
saveRDS(text,'Arthur1text.RDS')
saveRDS(chars,'Arthur1chars.RDS')
