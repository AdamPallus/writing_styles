...
library(stringi)
z<-readLines('troilus.txt',encoding="UTF-8-BOM",skipNul=TRUE)
...
save_model_hdf5(model,'TroilusModel1.hd5') 
saveRDS(text,'Troilus1text.RDS')
saveRDS(chars,'Troilus2chars.RDS')
